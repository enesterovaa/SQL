...
SELECT SUBSTR (LastName, 1, 1) letter, COUNT (*)
    FROM Customer
...
SELECT Customer.FirstName, Customer.LastName, Invoice.CustomerId, SUM(Invoice.Total)
FROM Customer
INNER JOIN Invoice
...
SELECT FirstName, LastName, Email, Invoice.CustomerId, 
